...
function AddTaskButton({ onClick, stepId }) {
  ...
  return active ? (
    <div>
      <div className="bg-white rounded-lg border-l-6 border-[#F1B81F] text-black p-2 font-medium m-2 mt-0">
        <input
    ...
    <button
      ...
      className="bg-transparent text-lg flex flex-1 items-center justify-start m-2 rounded-lg hover:bg-white/14 cursor-pointer"
    >
      <Plus />
      Adicionar Tarefa
    </button>
